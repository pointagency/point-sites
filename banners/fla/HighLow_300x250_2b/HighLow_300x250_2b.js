...
(lib.t3 = function() {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-0.3,32.5);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-112.1,0,224.3,59.7);
...
(lib.t2 = function() {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-0.3,31.2);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-96.1,0,192.2,59.7);
...
(lib.t1 = function() {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(0.3,18.9);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-64.1,0,128.3,34.4);
...
(lib.note_10 = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FEFEFE").s().p("AgcBYQgMgMAAgTIAAhxQAAgTAMgMQAMgLAQAAQARAAAMALQAMAMAAATIAABxQAAATgMAMQgMALgRAAQgQAAgMgLgAgIhCQgEAEAAAGIAABxQAAAGAEAEQADAEAFAAQAFAAAEgEQAEgEAAgGIAAhxQAAgGgEgEQgEgEgFAAQgFAAgDAEg");
	this.shape.setTransform(55.5,20.5,0.66,0.66);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FEFEFE").s().p("AAABiIAAilIgbAVIAAgeIAbgVIAbAAIAADDg");
	this.shape_1.setTransform(48.2,20.5,0.66,0.66);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DB5A35").s().p("AiCCDQg2g3gBhMQABhMA2g2QA3g3BLAAQBMAAA3A3QA2A2AABMQAABNg2A2Qg3A3hMAAQhLAAg3g3g");
	this.shape_2.setTransform(52.6,20.5,0.66,0.66);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#EDECEC").s().p("AoaD+QgKgYgUgQQgUgRgagFIAAl/QAagFAUgRQAUgQAKgYIQ1AAQAJAYAVARQATASAaAFIAAF9QgYAFgVARQgUAQgKAYg");
	this.shape_3.setTransform(52.6,20.5,0.66,0.66);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#DB5A35").s().p("AqdE1IAApqIU7AAIAAJqg");
	this.shape_4.setTransform(52.7,20.5,0.66,0.66);
...
(lib.m2 = function() {
	...
	this.shape.setTransform(43.6,20.4);
...
p.nominalBounds = new cjs.Rectangle(0,0,70.9,51.5);
...
(lib._10 = function() {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(24,25.5);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,48.9,51.5);
...
(lib.btn = function(mode,startPosition,loop) {
	...
	// Layer 6
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(0.3,25.2);
...
// stage content:
(lib.HighLow_300x250_2b = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_7.setTransform(149.2,62.7,1,1,0,0,0,0,29.9);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(57).to({_off:false},0).to({alpha:1},9).wait(67).to({y:-26.3},9,cjs.Ease.get(0.9)).to({_off:true},1).wait(109));
	...
	this.instance_12.setTransform(-149.9,133.6,1,1,0,0,0,73.4,44.3);
